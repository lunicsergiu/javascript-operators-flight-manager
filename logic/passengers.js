function Passengers() {
  ...
  const distributeAllSeatsToAllPassengers = (
    ...
    let vipBusinessConfiguration = {
      passengers: vipPassengers,
      seats: availableBusinessSeats,
    };
    vipPassengersWithBusinessSeats = updateConfiguration(
      vipBusinessConfiguration,
      businessSeatsPerFlight
    );

    let vipEconomyConfiguration = {
      passengers: vipBusinessConfiguration.passengers,
      seats: availableEconomySeats,
    };
    vipPassengersWithEconomySeats = updateConfiguration(
      vipEconomyConfiguration,
      economySeatsPerFlight
    );

    let regularBusinessConfiguration = {
      passengers: regularPassengers,
      seats: vipBusinessConfiguration.seats,
    };
    regularPassengersWithBusinessSeats = updateConfiguration(
      regularBusinessConfiguration,
      businessSeatsPerFlight
    );

    let regularEconomyConfiguration = {
      passengers: regularBusinessConfiguration.passengers,
      seats: vipEconomyConfiguration.seats,
    };
    regularPassengersWithEconomySeats = updateConfiguration(
      regularEconomyConfiguration,
      economySeatsPerFlight
    );
  ...
  const updateConfiguration = (configuration, seatsPerFlight) => {
